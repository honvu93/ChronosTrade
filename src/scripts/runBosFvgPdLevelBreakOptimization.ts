...
const SIGNALS = ['SYS_4TF_BOS_FVG_LONG', 'SYS_4TF_PD_LEVEL_BREAK_LONG'] as const;
...
async function main() {
    ...
    console.log(`\n${'═'.repeat(70)}`);
    console.log(`  BOS_FVG & PD_LEVEL_BREAK LONG — Multi-Timeframe Optimization`);
    ...
    try {
        ...
        const artifactDir = path.resolve('.artifacts/tf-optimization/BOS_FVG_PD_LEVEL_BREAK');
